...
export default function MarketPage() {
  ...
  useEffect(() => {
    if (candles.length && canvasRef.current) {
  ...
  return (
    <div style={{ padding: '32px', maxWidth: '1300px' }}>
      ...
      <div style={{ ...card, marginBottom: '16px' }}>
        {/* Chart header */}
        <div style={{ padding: '12px 16px', borderBottom: '1px solid #1e2a40', display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' as const }}>
          ...
          <div style={{ display: 'flex', gap: '4px', marginLeft: 'auto' }}>
            {TIMEFRAMES.map(t => (
              <button key={t} onClick={() => setTf(t)} style={{
                ...
                ...mono, fontSize: '10px', fontWeight: tf === t ? 700 : 400,
                transition: 'all .15s'
              }}>
                {t}
              </button>
